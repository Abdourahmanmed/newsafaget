      ...
      <div className="flex flex-col gap-8 md:flex-row">
        ...
        >
          ...
          <p className="font-medium text-sm sm:text-base md:text-lg">
            Chez Safa Jet, notre mission est claire : transformer vos idées en
            œuvres d'art imprimées exceptionnelles. Que vous recherchiez des
            impressions grand format qui ne passent pas inaperçues, des imprimés
            personnalisés qui reflètent votre identité, des produits
            promotionnels innovants ou un service de design graphique de pointe,
            nous sommes là pour donner vie à votre vision.
          </p>
        </motion.div>
        <motion.div
